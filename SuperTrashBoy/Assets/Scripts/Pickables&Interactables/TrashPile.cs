...
public class TrashPile : MonoBehaviour
{
    ...
    [SerializeField] private WeaponUpgradePickable stickPrefab;
    [SerializeField] private int numberOfHealthSpawn;
    [SerializeField] private int numberOfSticksSpawn;
    ...
    public void SpawnPickables()
    {
        ...
        for (int i = 0; i < numberOfSticksSpawn; i++)
        {
            WeaponUpgradePickable instance = Instantiate(stickPrefab, transform.position, Quaternion.identity);
